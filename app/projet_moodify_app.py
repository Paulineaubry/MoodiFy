...
# -------- Crée et configure le client Spotify avec authentification OAuth -------- #
@st.cache_resource
...
# -------- Récupère l'URL de la couverture d'album via l'API Spotify -------- #
...
# -------- Crée une nouvelle playlist publique sur Spotify --------- #
...
# -------- Charge le dataset des chansons depuis le fichier CSV -------- #
@st.cache_data
def load_data():
...
# DÉFINITION DES PERMISSIONS SPOTIFY
...
if choice == "Mood-to-Playlist":
    ...
    if humeurs_list:
        ...
        st.markdown(f"<div class='mood-display'></div>", unsafe_allow_html=True)
